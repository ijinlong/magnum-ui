...
(function() {
  ...
  angular
    ...
    .controller('createPodInfoController', createPodInfoController)
  ...
  createPodInfoController.$inject = [
    '$q',
    '$scope',
  ...
  function createPodInfoController($q, $scope, basePath, magnum) {
    var ctrl = this;
    ctrl.baymodels = {};
    ctrl.bays = [{id:"", name: gettext("Choose a Bay Name")}];
    $scope.model.newPodSpec.bay_uuid = "";
    $scope.baydetail = {
            name: "",
            id: "",
            baymodel: "",
    ...
    $scope.changeBay = function(){
        // show Bay Detail
        if(!$scope.model.newPodSpec.bay_uuid){
          $("#bay_detail").hide();
          $("#bay_detail_none").show();
        } else {
          angular.forEach(ctrl.bays, function(bay, idx){
            if($scope.model.newPodSpec.bay_uuid === bay.id){
              $("#bay_detail").show();
