...
(function() {
  ...
  angular
    ...
    .controller('containersPodController', containersPodController);

  containersPodController.$inject = [
    '$modal',
    '$window',
  ...
  function containersPodController($modal, $window, basePath, magnum) {
    var ctrl = this;

    ctrl.openPodCreateWizard = openPodCreateWizard;

    function openPodCreateWizard(launchContext) {
      var options = {
        controller: 'ModalContainerController',
        backdrop: 'static',
        template: '<wizard ng-controller="createPodWizardController"></wizard>"',
