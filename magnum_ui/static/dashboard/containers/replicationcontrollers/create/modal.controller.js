...
(function() {
  ...
  angular
    ...
    .controller('containersRCController', containersRCController);

  containersRCController.$inject = [
    '$modal',
    '$window',
  ...
  function containersRCController($modal, $window, basePath, magnum) {
    var ctrl = this;

    ctrl.openRCCreateWizard = openRCCreateWizard;

    function openRCCreateWizard(launchContext) {
      var options = {
        controller: 'ModalContainerController',
        backdrop: 'static',
        template: '<wizard ng-controller="createRCWizardController"></wizard>"',
